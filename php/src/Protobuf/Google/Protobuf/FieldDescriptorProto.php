...
class FieldDescriptorProto extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Google\Protobuf\FieldDescriptorProto\Label::class);
        $this->label = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Protobuf\FieldDescriptorProto\Type::class);
        $this->type = $var;
    ...
    /**
     * Generated from protobuf field <code>optional .google.protobuf.FieldOptions options = 8;</code>
     * @return \Google\Protobuf\FieldOptions|null
     */
